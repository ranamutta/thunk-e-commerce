...
const BasketPage = () => {
  ...
  return (
    ...
    <div className="row px-4 py-5">
      ...
      {state.isError && (<p className='text-center my-5 fw-bold'>Üzgünüz verileri alırken hata oluştu: <br /> {state.isError}</p>)}
      ...
      <div className="col-md-4">
        <div className="bg-white p-5 rounded w-100 text-black">
          ...
          <button className="w-100 my-2 bg-dark text-white">Alışverişi Tamamla</button>
        </div>
